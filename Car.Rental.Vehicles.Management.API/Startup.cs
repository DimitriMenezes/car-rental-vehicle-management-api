...
using Car.Rental.Vehicles.Management.API.IoC;

namespace Car.Rental.Vehicles.ManagementAPI
{
    public class Startup
    {
        ...
        {            
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Car Rental Vehicle Management API",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Car Rental Vehicle Management API");
